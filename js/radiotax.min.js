(function($) {
    ...
    $("div.radio-buttons-for-taxonomies input[type=checkbox]").on('change', function () {
        if($(this).is(':checked') ) {
            $("div.radio-buttons-for-taxonomies input[type=radio]").prop('checked', false );
        }
    });

    $("div.radio-buttons-for-taxonomies input[type=radio]").on('change', function () {
        if($(this).is(':checked') ) {
            $("div.radio-buttons-for-taxonomies input[type=checkbox]").prop('checked', false );
        }
    });
